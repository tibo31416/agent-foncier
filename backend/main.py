...
def _build_prompt(req: AnalyseRequest, pdf_result: dict) -> str:
    ...
    return f"""Tu es expert en urbanisme français et promotion immobilière.
...
{{
  ...
  "regles_hauteur": {{"hauteur_max": "valeur ou null", "regles_specifiques": "description avec article"}},
  "regles_implantation": {{"retrait_rue": "valeur", "retrait_limites": "valeur", "emprise_sol_max": "% ou null"}},
  "surface_constructible": {{"shon_estimee": "m²", "nb_niveaux_max": "nombre ou null", "methode_calcul": "explication"}},
  "stationnement": "règles",
  "performances_energetiques": "RE2020 ou autre",
  "contraintes_techniques": {{
    "fondations": "type selon sol",
    "delai_pc_estime": "mois avec justification",
    "surcoût_estime": "estimation",
    "points_bloquants": ["point 1"]
  }},
  "points_attention": ["point 1", "point 2"],
  "opportunite_promoteur": {{"score": 65, "commentaire": "évaluation synthétique"}},
